...
const KpiDefinitionsPage = dynamic(() => import('../kpi-definitions/page'), { 
  loading: () => <div className="p-4">Loading KPI Definitions...</div>
});
const KpiAssignmentPage = dynamic(() => import('../kpi-assignment/page'), { 
  loading: () => <div className="p-4">Loading KPI Assignment...</div>
});
const KpiTrackingPage = dynamic(() => import('../kpi-tracking/page'), { 
  loading: () => <div className="p-4">Loading KPI Tracking...</div>
});
const MetricsPage = dynamic(() => import('../metrics/page'), { 
